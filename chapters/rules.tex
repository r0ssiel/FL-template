...
Quando você possui um MODIFICADOR, adicione ou remova Dados de Perícia da sua rolagem. Ajudar equivale um bônus +1 (max. +3). Se você tiver Dados de Perícia negativos, \epsdice{6} nos Dados de Perícia cancelam demais \epsdice{6} da rolagem.
